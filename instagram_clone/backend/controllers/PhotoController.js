...
const insertPhoto = async (req, res) => {
    ...
    if (!newPhoto) {
        res.status(422).json({
            errors: ["Houve uum problema, por favor tente novamente mais tarde"]
        })
...
const likePhoto = async(req, res) => {
    ...
    //check if usr already liked the photo
...
const commentPhoto = async(req, res)=> {
    ...
    res.status(200).json({comment: userComment, message: ["Comentário inserido com sucesso"]})
}
