...
const likePhoto = async (req, res) => {
    ...
    return res.status(200).json({ photoId, userId: reqUser._id, message: "A foto foi curtida" })
}
...
const commentPhoto = async (req, res) => {
    ...
    return res.status(200).json({ comment: userComment, message: "Comentário adicionado com sucesso" })
}
